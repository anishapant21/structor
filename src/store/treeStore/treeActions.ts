...
export interface selectMultipleNodesAction {
    ...
    orderTreeData: Node[];
    selectedNodes: { node: Node; path: number; }[];
    event: React.MouseEvent,
    node: Node,
    extendedNode : ExtendedNode
    setSelectedNodes: React.Dispatch<React.SetStateAction<{ node: Node; path: number; }[]>>;
